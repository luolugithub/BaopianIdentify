...
from instance.mrcnn.config import Config
from instance.mrcnn import model as modellib, utils
...
if __name__ == '__main__':
    ...
    parser.add_argument("--allow-growth", action="store_true", help="Tensorflow 2 GPU compatibility flag",
                        required=False)
